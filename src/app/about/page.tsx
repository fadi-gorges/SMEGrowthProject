...
const AboutPage = () => {
  return (
    <Main>
      ...
      <h1 className="md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-teal-500 text-4xl mb-2 ">Learn about us!</h1>
      <p className="italic text-xl mb-16">Discover the journey that started AusBizGrowth.ai</p>
  ...
  <div className="right-section text-right pl-80"> {/* Adjusted padding-left */}
...
<section className="py-12 bg-white">
  ...
  <div className="flex flex-wrap justify-center items-start">
    ...
    <div className="text-center p-4 mx-6 bg-gray-100 rounded-lg">
      <Image src="/images/Team1.jpg" alt="First Name Last Name" width={200} height={200} className="rounded-lg mx-auto"/>
      <h3 className="text-lg font-bold mt-4">First Name Last Name</h3>
      <p className="text-sm text-gray-600">Position</p>
      <p className="text-sm text-gray-500">Company</p>
    </div>
    <div className="text-center p-4 mx-6 bg-gray-100 rounded-lg">
      <Image src="/images/Team2.jpg" alt="First Name Last Name" width={200} height={200} className="rounded-lg mx-auto"/>
      <h3 className="text-lg font-bold mt-4">First Name Last Name</h3>
      <p className="text-sm text-gray-600">Position</p>
      <p className="text-sm text-gray-500">Company</p>
    </div>
    <div className="text-center p-4 mx-6 bg-gray-100 rounded-lg">
      <Image src="/images/Team3.jpg" alt="First Name Last Name" width={200} height={200} className="rounded-lg mx-auto" />
      <h3 className="text-lg font-bold mt-4">First Name Last Name</h3>
      <p className="text-sm text-gray-600">Position</p>
      <p className="text-sm text-gray-500">Company</p>
    </div>
...
<section className="bg-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-center text-sm mt-2 font-style: italic">
            Students from Software Development Studio (Autumn 2024). From left to right, Piradon Phuangthong, 
            Siddhika Prasad, Fadi Gorges, Joseph Kizana, Wilson Lowell, Gifford Stefano, Sejin (Denim) Um, 
            Matthew Ashley.
          </p>
        </div>
        <div className="mt-16 text-center px-64">
          ...
          <p className="mt-2 text-lg">
            With your interest and support the continuation of this story hopefully results in the final build 
            of a commercially robust platform that over time will be used by many organisations seeking to 
            engage with high growth potential SMEs. A platform that will generate sufficient revenue to 
            self-fund continuous improvement, user support and maintenance.
          </p>
        </div>
      </section>
