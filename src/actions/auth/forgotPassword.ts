...
export const forgotPasswordAction = async (
  ...
  await payload.sendEmail({
    ...
    html: `
        ...
        <a href="${getUrl()}/auth/reset-password/${
      user.resetPasswordToken
    }" style="display: inline-block; padding: 12px 24px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 4px;">Reset your password</a>
        `,
  });
